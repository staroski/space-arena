...
class LoginFrame extends JFrame {
	...
	LoginFrame(LoginListener listener) throws IOException {
		super(SpaceArena.GAME_NAME + " - Login");
	...
	private void initGUI() throws IOException {
		...
		// painel dos botões login e cancelar
		...
		buttonLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				try {
					...
					SpaceArenaClient.setProxy(props.getProxyHost(), props.getProxyPort(), props.getProxyUsername(), props.getProxyPassword());
